      ...
      {isObject(session?.user) ? (
        ...
        <>
          ...
          <footer className="flex gap-4">
            <Link className="w-full" href="/customer/login" onClick={onClose} aria-label="Ir a la página de inicio de sesión">
              <button
                className={clsx(
            ...
            <Link className="w-full" href="/customer/register" onClick={onClose} aria-label="Ir a la página de crear cuenta">
              <button
                className={clsx(
