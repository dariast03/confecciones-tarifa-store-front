...
export async function generateMetadata({
  ...
  const title = searchQuery
    ? `${searchQuery} - Buscar en Confecciones Tarifa | Ropa Artesanal Chapaca`
    : "Buscar Productos | Confecciones Tarifa - Ropa para Carnaval Chapaco";

  const description = searchQuery
    ? `Encuentra ${searchQuery} en nuestra colección de ropa artesanal para carnaval chapaco. Confecciones Tarifa ofrece trajes típicos, polleras, blusas bordadas a mano y más.`
    : "Explora nuestra colección completa de ropa artesanal para carnaval chapaco. Trajes típicos, polleras, blusas bordadas y accesorios hechos a mano en Tarija, Bolivia.";
