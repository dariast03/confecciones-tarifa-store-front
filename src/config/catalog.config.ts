...
export function getCatalogConfig(params?: URLSearchParams): CatalogConfig {
  if (!params?.size) return defaultCatalogConfig;

  return {
    showPrice: params.get('showPrice') !== 'false',
    businessName:
      params.get('businessName') || defaultCatalogConfig.businessName,
    contactNumber:
      params.get('contactNumber') || defaultCatalogConfig.contactNumber,
    whatsappNumber:
      params.get('whatsappNumber') || defaultCatalogConfig.whatsappNumber,
    ...
    secondaryColor:
      params.get('secondaryColor') || defaultCatalogConfig.secondaryColor,
  };
}
